...
public class StandardIdentityPropertiesFilterTest {
    ...
    @Mock private IdentityBuilderPort identityBuilderPort;

    @Mock private IdentityPort identityPort;

    @Mock private EmailAddressPort EmailAddressPort;

    @InjectMocks private StandardIdentityPropertiesFilter standardIdentityPropertiesFilter;
    ...
    public void testFilterWithValidProperties() throws InvalidArgumentsException {
        ...
        String[] properties =
                new String[] {
                    "name", "email", "replyTo", "bcc", "textSignature", "htmlSignature", "mayDelete"
                };
        ...
        StandardIdentityPropertiesFilter standardIdentityPropertiesFilter =
                new StandardIdentityPropertiesFilter(identityBuilderPort);
    ...
    public void testFilterWithInvalidArgumentsException() throws InvalidArgumentsException {
        ...
        assertThrows(
                ...
                () -> standardIdentityPropertiesFilter.filter(identitys, properties));
    }
}
