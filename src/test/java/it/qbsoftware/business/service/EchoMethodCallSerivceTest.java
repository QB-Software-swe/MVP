...
public class EchoMethodCallSerivceTest {
    ...
    @Mock private MethodResponsePort methodResponsePort;

    @Mock private EchoMethodCallPort echoMethodCallPort;

    @Mock private EchoMethodResponseBuilderPort echoMethodResponseBuilderPort;

    @Mock private EchoMethodResponsePort echoMethodResponsePort;

    @InjectMocks private EchoMethodCallSerivce echoMethodCallSerivce;
    ...
    public void callEchoMethodCallService() {
        ...
        when(echoMethodResponseBuilderPort.payload(payload))
                .thenReturn(echoMethodResponseBuilderPort);
