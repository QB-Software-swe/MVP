...
public class SetEmailSubmissionMethodCallServiceTest {
    ...
    @Mock
    private SetEmailSubmissionMethodResponsePort setEmailSubmissionMethodResponsePort;

    @Mock
    private SetEmailSubmissionMethodCallPort setEmailSubmissionMethodCallPort;
    ...
    @InjectMocks
    SetEmailSubmissionMethodCallService setEmailSubmissionMethodCallService;
    ...
    public void testCall() throws Exception{
        ...
        when(setEmailSubmissionMethodResponseBuilderPort.reset()).thenReturn(setEmailSubmissionMethodResponseBuilderPort);
        when(setEmailSubmissionMethodResponseBuilderPort.oldState(any())).thenReturn(setEmailSubmissionMethodResponseBuilderPort);
        when(setEmailSubmissionMethodResponseBuilderPort.newState(any())).thenReturn(setEmailSubmissionMethodResponseBuilderPort);
        when(setEmailSubmissionMethodResponseBuilderPort.created(any())).thenReturn(setEmailSubmissionMethodResponseBuilderPort);
        when(setEmailSubmissionMethodResponseBuilderPort.build()).thenReturn(setEmailSubmissionMethodResponsePort);
        ...
        when(setEmailMethodResponseBuilderPort.accountId(accountId)).thenReturn(setEmailMethodResponseBuilderPort);
        ...
        SetEmailSubmissionMethodResponse result = setEmailSubmissionMethodCallService.call(setEmailSubmissionMethodCallPort, previousResponses);
