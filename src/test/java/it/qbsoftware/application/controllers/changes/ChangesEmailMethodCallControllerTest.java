...
public class ChangesEmailMethodCallControllerTest {
    ...
    @Mock ChangesEmailMethodCallUsecase changesEmailMethodCallUsecase;

    @Mock ListMultimapPort<String, ResponseInvocationPort> previousResponses;

    @Mock ChangesEmailMethodResponseAdapter changesEmailMethodResponseAdapter;

    @Mock MethodCall methodCall;

    @Mock ChangesEmailMethodResponse changesEmailMethodResponse;

    @InjectMocks ChangesEmailMethodCallController changesEmailMethodCallController;

    @Test
    public void testHandle() throws Exception {
        ChangesEmailMethodCall changesEmailMethodCall =
                new ChangesEmailMethodCall("null", "null", 1L);
        HandlerRequest handlerRequest =
                new HandlerRequest(changesEmailMethodCall, previousResponses);

        when(changesEmailMethodCallUsecase.call(any(), any()))
                .thenReturn(changesEmailMethodResponseAdapter);
