...
public class EmailChangesTrackerRepositoryAdapterTest {
    ...
    public void setUp() {
        ...
        underTest = new EmailChangesTrackerRepositoryAdapter(
    ...
    void testRetrive() {
        ...
        MongoClients.create(mongoDBContainer.getConnectionString()).getDatabase("jmap").getCollection("email_changes")
                .insertOne(doc);
    ...
    void testSave() {
        ...
        var result = MongoClients.create(mongoDBContainer.getConnectionString()).getDatabase("jmap")
                .getCollection("email_changes")
                .find(Filters.eq("_id", id));

        assertTrue(gson.fromJson(result.first().toJson(), SimpleEmailChangesTracker.class).id().equals(id));
    }
}
