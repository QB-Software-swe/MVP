...
import it.qbsoftware.business.services.SetMailboxMethodCallService;
...
public class SetMailboxMethodCallController extends ControllerHandlerBase{
    ...
    public MethodResponse[] handle(HandlerRequest handlerRequest) {
        if (handlerRequest.methodCall() instanceof SetMailboxMethodCall setMailboxMethodCall) {
            ...
            SetMailboxMethodCallAdapter setMailboxMethodCallAdapter = new SetMailboxMethodCallAdapter(setMailboxMethodCall);

            SetMailboxMethodCallUsecase setMailboxMethodCallService = new SetMailboxMethodCallService(new SetMailboxMethodResponseBuilderAdapter(), new  StateMismatchMethodErrorResponseAdapter(), new  MailboxBuilderAdapter(), new MailboxInfoRepositoryAdapter(), new SetErrorAdapter(), new  SplitterAdapter(), new CaseFormatAdapter(), new RoleAdapter(null));

            MethodResponseAdapter[] methodResponseAdapters = (MethodResponseAdapter[]) setMailboxMethodCallService.call(setMailboxMethodCallAdapter);
