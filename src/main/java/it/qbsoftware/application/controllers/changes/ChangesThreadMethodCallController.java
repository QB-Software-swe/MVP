...
public class ChangesThreadMethodCallController extends ControllerHandlerBase {
    ...
    @Inject
    public ChangesThreadMethodCallController(
            final ChangesThreadMethodCallUsecase changesThreadMethodCallUsecase) {
    ...
    public MethodResponse[] handle(final HandlerRequest handlerRequest) {
        if (handlerRequest.methodCall()
                instanceof ChangesThreadMethodCall changesThreadMethodCall) {
            final ChangesThreadMethodCallAdapter changesThreadMethodCallAdapter =
                    new ChangesThreadMethodCallAdapter(changesThreadMethodCall);
            logger.info("Match and handle method call recived");
            try {
                final ChangesThreadMethodResponseAdapter changesThreadMethodResponseAdapter =
                        (ChangesThreadMethodResponseAdapter)
                                changesThreadMethodCallUsecase.call(
                                        changesThreadMethodCallAdapter,
