...
public class ChangesEmailMethodCallController extends ControllerHandlerBase {
    ...
    @Inject
    public ChangesEmailMethodCallController(
            final ChangesEmailMethodCallUsecase changesEmailMethodCallUsecase) {
    ...
    public MethodResponse[] handle(final HandlerRequest handlerRequest) {
        if (handlerRequest.methodCall() instanceof ChangesEmailMethodCall changesEmailMethodCall) {
            final ChangesEmailMethodCallAdapter ChangesEmailMethodCallAdapter =
                    new ChangesEmailMethodCallAdapter(changesEmailMethodCall);
            logger.info("Match and handle method call recived");
            try {
                final ChangesEmailMethodResponseAdapter changesEmailMethodResponseAdapter =
                        (ChangesEmailMethodResponseAdapter)
                                changesEmailMethodCallUsecase.call(
                                        ChangesEmailMethodCallAdapter,
