...
public class SetMailboxMethodCallController extends ControllerHandlerBase {
    ...
    public MethodResponse[] handle(final HandlerRequest handlerRequest) {
        if (handlerRequest.methodCall() instanceof SetMailboxMethodCall setMailboxMethodCall) {
            ...
            final SetMailboxMethodCallAdapter setMailboxMethodCallAdapter =
                    new SetMailboxMethodCallAdapter(setMailboxMethodCall);
            logger.info("Match and handle method call recived");
            try {
                final SetMailboxMethodResponseAdapter setMailboxMethodResponseAdapter =
                        (SetMailboxMethodResponseAdapter)
                                setMailboxMethodCallUsecase.call(
                                        setMailboxMethodCallAdapter,
