...
public class EchoMethodCallController extends ControllerHandlerBase {
    ...
    public MethodResponse[] handle(final HandlerRequest handlerRequest) {
        if (handlerRequest.methodCall() instanceof EchoMethodCall echoMethodCall) {
            ...
            final EchoMethodCallAdapter echoMethodCallAdapter =
                    new EchoMethodCallAdapter(echoMethodCall);

            final EchoMethodResponseAdapter echoMethodResponseAdapter =
                    (EchoMethodResponseAdapter) echoMethodCallUsecase.call(echoMethodCallAdapter);
