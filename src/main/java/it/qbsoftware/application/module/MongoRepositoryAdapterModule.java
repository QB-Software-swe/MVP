...
public class MongoRepositoryAdapterModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(MailboxChangesTrackerRepository.class)
                .to(MailboxChangesTrackerRepositoryAdapter.class);
        ...
        bind(IdentityChangesTrackerRepository.class)
                .to(IdentityChangesTrackerRepositoryAdapter.class);
        bind(MailboxChangesTrackerRepository.class)
                .to(MailboxChangesTrackerRepositoryAdapter.class);
    }
