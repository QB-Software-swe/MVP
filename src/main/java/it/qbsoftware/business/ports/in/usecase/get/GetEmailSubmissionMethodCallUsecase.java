...
public interface GetEmailSubmissionMethodCallUsecase {
    public GetEmailSubmissionMethodResponsePort call(final GetEmailSubmissionMethodCallPort getEmailSubmissionMethodCallPort,
            final ListMultimapPort<String, ResponseInvocationPort> previousResponses) throws InvalidResultReferenceExecption, AccountNotFoundException, InvalidArgumentsException;
}
