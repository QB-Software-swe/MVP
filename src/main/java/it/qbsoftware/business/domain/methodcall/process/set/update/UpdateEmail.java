...
public interface UpdateEmail {
        ...
        UpdatedResult<EmailPort> update(SetEmailSubmissionMethodCallPort setEmailSubmissionMethodCallPort,
                        ListMultimapPort<String, ResponseInvocationPort> previousResponses,
                        Map<String, String> successSubmissionEmailIdResolve) throws AccountNotFoundException;
