...
public class ThreadChangesTrackerRepositoryAdapter implements ThreadChangesTrackerRepository {
    private static final String COLLECTION = "thread_changes";
    private final MongoConnection mongoConnection;
    private final Gson gson;

    @Inject
    public ThreadChangesTrackerRepositoryAdapter(
    ...
    public ThreadChangesTracker retrive(final String accountId) {
        ...
        if (threadChangesTrackerDoc != null) {
            return gson.fromJson(
                    threadChangesTrackerDoc.toJson(), SimpleThreadChangesTracker.class);
        } else {
    ...
    public void save(final ThreadChangesTracker threadChangesTracker) {
        ...
        mongoConnection
                ...
                .findOneAndReplace(
                        Filters.eq("_id", threadChangesTracker.id()),
                        threadChangesTrackerDoc,
                        options);
    }
}
