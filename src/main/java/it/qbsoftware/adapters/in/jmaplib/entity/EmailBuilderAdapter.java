...
public class EmailBuilderAdapter implements EmailBuilderPort {
    ...
    public EmailBuilderPort sender(final List<EmailAddressPort> sender) {
        emailBuilder.sender(
                sender != null ? sender.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    }
    ...
    public EmailBuilderPort from(final List<EmailAddressPort> from) {
        emailBuilder.from(
                from != null ? from.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    };
    ...
    public EmailBuilderPort to(final List<EmailAddressPort> to) {
        emailBuilder.to(
                to != null ? to.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    }
    ...
    public EmailBuilderPort cc(final List<EmailAddressPort> cc) {
        emailBuilder.cc(
                cc != null ? cc.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    }
    ...
    public EmailBuilderPort bcc(final List<EmailAddressPort> bcc) {
        emailBuilder.bcc(
                bcc != null ? bcc.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    }
    ...
    public EmailBuilderPort replyTo(final List<EmailAddressPort> replyTO) {
        emailBuilder.replyTo(
                replyTO != null ? replyTO.stream().map(e -> ((EmailAddressAdapter) e).adaptee()).toList() : null);
        return this;
    }
    ...
    public EmailBuilderPort textBody(final Collection<EmailBodyPartPort> textBody) {
        emailBuilder.textBody(textBody != null
                ? textBody.stream().map(e -> ((EmailBodyPartAdapter) e).adaptee()).collect(Collectors.toList())
                : null);
        return this;
    }
    ...
    public EmailBuilderPort htmlBody(final Collection<EmailBodyPartPort> htmlBody) {
        emailBuilder.htmlBody(htmlBody != null
                ? htmlBody.stream().map(h -> ((EmailBodyPartAdapter) h).adaptee()).collect(Collectors.toList())
                : null);
        return this;
    }
    ...
    public EmailBuilderPort attachments(final Collection<EmailBodyPartPort> attachments) {
        emailBuilder.attachments(
                attachments != null
                        ? attachments.stream().map(a -> ((EmailBodyPartAdapter) a).adaptee())
