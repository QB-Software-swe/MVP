...
public class SetEmailSubmissionMethodResponseBuilderAdapter implements SetEmailSubmissionMethodResponseBuilderPort {
    private SetEmailSubmissionMethodResponseBuilder setEmailSubmissionMethodResponseBuilder = SetEmailSubmissionMethodResponse
            .builder();
    ...
    public SetEmailSubmissionMethodResponseBuilderPort created(final Map<String, EmailSubmissionPort> created) {
        setEmailSubmissionMethodResponseBuilder.created(created.entrySet().stream()
                .collect(Collectors.toMap(e -> e.getKey(), e -> ((EmailSubmissionAdapter) e.getValue()).adaptee())));
        return this;
    }

    @Override
    public SetEmailSubmissionMethodResponseBuilderPort updated(final Map<String, EmailSubmissionPort> updated) {
        setEmailSubmissionMethodResponseBuilder.updated(updated.entrySet().stream()
                .collect(Collectors.toMap(e -> e.getKey(), e -> ((EmailSubmissionAdapter) e.getValue()).adaptee())));
        return this;
    }
    ...
    public SetEmailSubmissionMethodResponseBuilderPort notCreated(final Map<String, SetErrorPort> notCreated) {
        setEmailSubmissionMethodResponseBuilder.notCreated(notCreated.entrySet().stream()
    ...
    public SetEmailSubmissionMethodResponseBuilderPort notUpdated(final Map<String, SetErrorPort> notUpdated) {
        setEmailSubmissionMethodResponseBuilder.notUpdated(notUpdated.entrySet().stream()
                .collect(Collectors.toMap(e -> e.getKey(), e -> ((SetErrorAdapter) e.getValue()).adaptee())));
        return this;
    }
    ...
    public SetEmailSubmissionMethodResponseBuilderPort notDestroyed(final Map<String, SetErrorPort> notDestroyed) {
        setEmailSubmissionMethodResponseBuilder.notDestroyed(notDestroyed.entrySet().stream()
                .collect(Collectors.toMap(e -> e.getKey(), e -> ((SetErrorAdapter) e.getValue()).adaptee())));
        return this;
    }
    ...
    public SetEmailSubmissionMethodResponsePort build() {
        return new SetEmailSubmissionMethodResponseAdapter(setEmailSubmissionMethodResponseBuilder.build());
    }
